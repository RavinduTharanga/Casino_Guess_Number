...
int main(){
    ...
    do{
        ...
        do{
			...
			cin >> bidAmount;
            if(bidAmount>amount){
                cout<<"you cannot play";
            }
        }
        while(bidAmount>amount);
        ...
        if(dice == guess){
            ...
            cout << "\nHurray You Won " << bidAmount * 10 << "$";
			amount = amount + bidAmount * 10;
          
        }
        else{
            cout<<"Sorry you loose"<<bidAmount*10<<"$";
    ...
    cout << "\n===============================================================================================\n";
	cout << "Thanks For Playing Game Again Your Current Amount Is " << amount << "$";
	cout << "\n===============================================================================================\n";
